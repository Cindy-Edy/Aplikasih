...
// Dirubah 
const pengirim = "tutu ndut";
const nomorWa = "6282367136420" // awalan nomor 0 harus di awalin 62
const textWa = ":)"
const pesan = `sllu sayang sama ku y ayangku,jangan suka marah-marah ya , semoga niat baik kita dilancar kan y ayang amin...`;
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    imageHeight: 120,
    title: 'Haii kesayangku yg tercinta,Semangat ya menjalani aktivitasnya',
    ...
    let txt = `Haiii, Nama kamu ${result.value.login}, Nama kamu berawal dari huruf ${namaAwal.toUpperCase()}, ${pesan}`;
